...
> **See also (2026-04-27)**: A separate reorganization relocated the ETL schema
> authoring source-of-truth out of this chapter to
> `shared/global_scripts/01_db/raw_schema/_authoring/` per amended **MP102** and
> the new **MP156 Two-Tier Normativity** binding mechanism (spectra change
> `glue-layer-prerawdata-bridge`, issue #489). See
> [`etl_schemas/MOVED_NOTICE.md`](etl_schemas/MOVED_NOTICE.md) for the file
> mapping. The DU-prefix reorganization documented below is unaffected.
