...
### Step 6: Layer 3 — 更新 .Codex/rules/*.md
...
5. 同步更新 .Codex/rules/*.md（Layer 3）
6. Commit（引用 issue 如果有）

## Notes

- DOC_R009 順序：.qmd → llm/*.yaml → .Codex/rules/*.md（不可顛倒）
