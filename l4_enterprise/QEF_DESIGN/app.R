...
# Load .Rprofile only when autoinit() is not already available.
# RStudio interactive sessions often source .Rprofile at startup.
if (!exists("autoinit", mode = "function", inherits = TRUE) &&
