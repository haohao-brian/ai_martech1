      ...
      output$hist_ipt <- renderPlotly({
        ...
        plotly::plot_ly(x = vals, type = "histogram",
          ...
          plotly::layout(
            ...
            # #389: top margin 60 left only 4px buffer above P80 annotation (ay=-56),
            # so P80 text was clipped on smaller plot containers ("P80=154 天" → "80=1…4 天").
            # Bump to 80 for ~24px buffer. (D_RACING reported, 2nd time.)
