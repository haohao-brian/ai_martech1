...
- **Primary Standard**: [MP164 Script Organization Evolution](docs/en/part1_principles/CH00_fundamental_principles/02_structure_organization/MP164_script_organization_evolution.qmd) (renumbered from MP104 per #616, 2026-05-10)
- **Five-Part Rule**: [DEV_R033 Five-Part Structure](docs/en/part1_principles/CH03_development_methodology/rules/DEV_R033_five_part_script_structure.qmd)
- **autodeinit Behavior**: [MP103 autodeinit](docs/en/part1_principles/CH00_fundamental_principles/02_structure_organization/MP103_autodeinit_behavior.qmd)
